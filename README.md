...
## Как пользоваться
Клонируешь репозиторий, билдишь приложение. Если лень, можно сразу запустить бинарник **interview** (собран на ubuntu x64)  
...
В блоке "Тренажер" появится окно с вопросом и окно, в которое нужно написать свой ответ. Ответ никуда не сохраняется, можно
ничего не писать, а отвечать устно. Но я предпочитаю писать, т.к. я лучше запоминаю, когда пишу. Потом кликаешь по "Проверить"
...
* Добавить возможность удалять и изменять вопросы и ответы
